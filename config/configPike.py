...
#subapLocation=FITS.Read("/home/dani/git/canaryLaserCommissioning/SHsubapLocation_led1.fits")[1].astype("f")
subapLocation=FITS.Read("/home/dani/git/canaryLaserCommissioning/SH_subapLocation_led_1.fits")[1].astype("f")
try:
    a=prefix
except:
    prefix="main"
